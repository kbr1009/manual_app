...
class Section(SortableMixin):
    section_name = models.CharField(verbose_name='1.セクション', max_length=50, blank=False, null=True)
...
class Job(SortableMixin):
    job_name = models.CharField(verbose_name='2.作業名', max_length=50, blank=False, null=True)
...
class Item(SortableMixin):
    item_name = models.CharField(verbose_name='3.作業項目', max_length=50, blank=False, null=True)
...
class Method(SortableMixin):
    method_name = models.CharField(verbose_name='4.作業方法', max_length=50, blank=False, null=True)
